...
bool interfaces__msg__control_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._control_msg.ControlMsg", full_classname_dest, 38) == 0);
  }
  interfaces__msg__ControlMsg * ros_message = _ros_message;
  {  // num
...
PyObject * interfaces__msg__control_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._control_msg");
