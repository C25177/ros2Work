...
interfaces__msg__ControlMsg__create()
{
  ...
  interfaces__msg__ControlMsg * msg = (interfaces__msg__ControlMsg *)allocator.allocate(sizeof(interfaces__msg__ControlMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__ControlMsg));
  bool success = interfaces__msg__ControlMsg__init(msg);
  if (!success) {
...
interfaces__msg__ControlMsg__destroy(interfaces__msg__ControlMsg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    interfaces__msg__ControlMsg__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
interfaces__msg__ControlMsg__Sequence__init(interfaces__msg__ControlMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__ControlMsg * data = NULL;

  if (size) {
    data = (interfaces__msg__ControlMsg *)allocator.zero_allocate(size, sizeof(interfaces__msg__ControlMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__ControlMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__ControlMsg__fini(&data[i - 1]);
      }
...
interfaces__msg__ControlMsg__Sequence__fini(interfaces__msg__ControlMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__ControlMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__ControlMsg__Sequence * array = (interfaces__msg__ControlMsg__Sequence *)allocator.allocate(sizeof(interfaces__msg__ControlMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__ControlMsg__Sequence__init(array, size);
  if (!success) {
...
interfaces__msg__ControlMsg__Sequence__destroy(interfaces__msg__ControlMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces__msg__ControlMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interfaces__msg__ControlMsg__Sequence__are_equal(const interfaces__msg__ControlMsg__Sequence * lhs, const interfaces__msg__ControlMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__ControlMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__msg__ControlMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__ControlMsg);
    interfaces__msg__ControlMsg * data =
      (interfaces__msg__ControlMsg *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__ControlMsg__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interfaces__msg__ControlMsg__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__msg__ControlMsg__copy(
